...
const client = new DeliverooApi(
    'http://localhost:8080',
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Ijg3ZjkyZTFhYTc0IiwibmFtZSI6ImR1bWIxIiwiaWF0IjoxNzAxODk2NTQzfQ.Qk2N_keLsffQmW3xXs3qnN6FYwhdqF3WA2oJdN7tsII'
)
const himynameis = "dumb0";
    ...
    if (  receivedMessage &&
        ...
        switch(messageType) {
            ...
            case MessageType.PLAN_ASSIGNMENT: // 
                ...
                console.log("[PLAN RECEIVED] - plan: " + JSON.stringify(plan))
                evaluate(plan);
                break;
