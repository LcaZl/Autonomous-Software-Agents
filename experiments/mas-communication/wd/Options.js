...
export class Options {
    ...
    updateOptionsForBfs(){
        ...
        currentOptionId = this.agent.intentions.currentIntention.option.id
    ...
    async updateOptionsForPddl(){
        ...
        let options = []
        let currentOption 
        if (this.agent.intentions.currentIntention.option)
            currentOption = this.agent.intentions.currentIntention.option
