...
export const multiagent = false
export const teamSize = 0 // Need a number only when multiagent is true
export const agents_configuration = [

    {
        ...
        duration: 300, // Infinity or seconds

        movementType: 'BFS', // BFS or PDDL
