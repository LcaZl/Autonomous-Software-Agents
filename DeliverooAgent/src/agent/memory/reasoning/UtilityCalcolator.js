...
export class UtilityCalcolator{
    ...
    deliveryUtility(startPosition) {
        ...
        if ((this.agent.duration - elapsedTime) < (deliveryDistance * (this.movementTime * 1.5))) { 
    ...
    simplifiedDeliveryUtility(startPosition, endPosition, deliveryDistance = null){
        ...
        if ((this.agent.duration - elapsedTime) < (deliveryDistance * (this.movementTime * 1.5))) {  return Infinity }
